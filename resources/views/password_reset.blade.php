...
<head>
    ...
    <title>Aryans Electronics | Password Reset</title>

    <meta name="keywords" content="" />
    <meta name="description" content="">


    <meta property="og:url" content="Aryans Electronics | Password Reset"/>
    <meta property="og:type" content="website"/>

    <meta property="og:title" content="" />
    <meta property="og:description" content="" />
    <meta property="og:image" content="<?php echo url('/');?>/assets/custom/images/aryans-electronics-shop.webp" />
    ...
    <div class="page-wrapper">
        ...
        <main class="main login-page">
            ...
            <div class="page-content">
                <div class="container">
                    <x-shared.password_reset_box_component :token="$token"/>
                </div>
            </div>
        </main>
        <!-- End of Main -->
