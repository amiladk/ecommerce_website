...
<head>
    ...
    <!-- HTML Meta Tags -->
    <title>Aryans Electronics | Forgot Password</title>
    ...
    <meta property="og:title" content="Aryans Electronics | Forgot Password">
    ...
    <meta name="twitter:title" content="Aryans Electronics | Forgot Password">
    ...
    <div class="page-wrapper">
        ...
        <main class="main login-page">
            ...
            <div class="page-content">
                <div class="container">
                    <x-shared.forget_pass_box_component/>
                </div>
            </div>
        </main>
        <!-- End of Main -->
