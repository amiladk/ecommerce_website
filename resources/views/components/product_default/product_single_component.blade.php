<div id="product-singale-block" class="product product-single row">
<div class="col-md-6 mb-6">
    ...
    <div class="col-md-6 mb-4 mb-md-6">
        <div class="product-details"  data-product="{{json_encode($items->data)}}" data-sticky-options="{'minWidth': 767}">
            ...
            @if($items->data->stock <= 0)
                <div class="text-danger show-out-of-stock" style="font-size: 15px">out of stock</div>
            @endif
                    ...
                    <div class="product-form container">
                        <div class="product-qty-form">
                            <div class="input-group">
                                ...
                                <button  data-max="{{$items->data->stock}}" class="quantity-plus w-icon-plus"></button>
