<script>
    ...
    $( document ).ready(function() {
        $.ajax({
            method:"get",
            url:"/api/get-product-single-more-products",
            cache:false,
            async: false,
            headers: {
            ...
            success:function(data){
                response = data;
                $('#product-single-more').html(response);
            },
        ...
        <div class="sticky-sidebar">
            ...
            <div class="widget widget-banner mb-9">
                <div class="banner banner-fixed br-sm">
                    <figure>
                        <img src="/assets/images/shop/banner3.webp" alt="Banner" width="266"
