<?php
    ...
    $items = Http::get(config('sitepecific.api_url').'departmentlink');  
    $list = json_decode($items);

    $categoriesitem = Http::get(config('sitepecific.api_url').'shop/categories?parent=null&depth=1');  
    $categories = json_decode($categoriesitem);
    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <a href="/contact_us" class="d-lg-show">Contact Us</a>
                <?php if($login){?>
                <a href="/my-account" class="d-lg-show">My Account</a>
                <?php }else{?>
                <a href="/login-popup" class="d-lg-show login sign-in pointer-events-none"><i
                        class="w-icon-account"></i>Sign In</a>
                <span class="delimiter d-lg-show">/</span>
                <a href="/login-popup" class="ml-0 d-lg-show login register pointer-events-none">Register</a>
                <?php }?>
            </div>
        </div>
    </div>
            ...
            <div class="header-right ml-4">
                ...
                <div class="dropdown cart-dropdown cart-offcanvas mr-0 mr-lg-2">
                    ...
                    <div class="dropdown-box">
                        ...
                        <div id="aryans-cart" class="products">

                        </div>

                        <div class="cart-total">
                            <label>Subtotal:</label>
                            <span id="drop-cart-sub-total" class="price">$58.67</span>
                        </div>
                                ...
                                @foreach($list as $key=>$item)
                                    ...
                                    <li>
                                        <a href="shop-fullwidth-banner.html">
                                            <i class="w-icon-electronics"></i>{{$item->label}}
                                        </a>
                                        <ul class="megamenu">
                                            @foreach($columns as $key2=>$item2)
                                                <li>
                                                    <h4 class="menu-title">{{$item2->items[0]->label}}</h4>
                                                    <hr class="divider">
                                                    <ul>
                                                        @foreach($item2->items[0]->items as $key3=>$item3)
                                                            <li><a href="shop-fullwidth-banner.html">{{$item3->label}}</a></li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                                            @endforeach
