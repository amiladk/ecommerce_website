<?php
    ...
    $iss = [
        config('sitepecific.api_url').'login',
        config('sitepecific.api_url').'signup',
        config('sitepecific.api_url').'socialsignup'
    ];
                    ...
                    @foreach($list as $key=>$item)
                        ...
                        <li>
                            <a href="shop-fullwidth-banner.html">
                                <i class="w-icon-tshirt2"></i>{{$item->label}}
                            </a>
                            <ul>
                            @foreach($columns as $key2=>$item2)
                                <li>
                                    <a href="#">{{$item2->items[0]->label}}</a>
                                    <ul>
                                    @foreach($item2->items[0]->items as $key3=>$item3)
                                        <li><a href="shop-fullwidth-banner.html">{{$item3->label}}</a>
                                        </li>
                                    @endforeach
                                    </ul>
                                </li>
