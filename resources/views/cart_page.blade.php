...
<head>
    ...
    <!-- HTML Meta Tags -->
    <title>Aryans Electronics | Cart</title>
    ...
    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="https://www.aryanselectronics.com/cart/">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Aryans Electronics | Cart">
    ...
    <meta property="twitter:url" content="https://www.aryanselectronics.com/cart/">
    <meta name="twitter:title" content="Aryans Electronics | Cart">
...
<x-shared.shared_body_component/>
    <div class="page-wrapper">
        ...
        <main class="main cart">
            <!-- Start of Breadcrumb -->
            <x-cart_page.cart_breadcrumb_nav_component/>
            <!-- End of Breadcrumb -->

            <!-- Start of PageContent -->
            <x-cart_page.cart_page_content_component/>
            <!-- End of PageContent -->
